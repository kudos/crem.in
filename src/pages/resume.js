        ...
        <SEO title="Resume" />
          <div className="resume">
            ...
            <div className="experience">
              ...
              <p>Senior Engineering Manager &mdash; November 2015 to Present</p>
              <ul>
            ...
            <div className="projects">
              ...
              <h3>Hostr <a href="https://hostr.co" className='screen'><GoLink size='0.7em' color='#1EAEDB' /></a> <a href="https://github.com/kudos/hostr" className='screen'><GoMarkGithub size='0.7em' color='#1EAEDB' /></a> <span className="print">(https://hostr.co)</span></h3>
              ...
              <h3>Combine.fm <a href="https://combine.fm" className='screen'><GoLink size='0.7em' color='#1EAEDB' /></a> <a href="https://github.com/kudos/combine.fm" className='screen'><GoMarkGithub size='0.7em' color='#1EAEDB' /></a> <span className="print">(https://combine.fm)</span></h3>
              ...
              <h3>Others <a href="https://github.com/kudos" className='screen'><GoMarkGithub size='0.7em' color='#1EAEDB' /></a> <span className="print">(https://github.com/kudos)</span></h3>
